...
features:
  ...
  - icon: 🧩
    title: Seven assertion kinds
    details: path_exists, path_absent, env_var_absent, script_exists, workflow_trigger, symbol_at_path, text_matches_across — one checker per kind, each independently testable.
  - icon: 🗂️
...
([SpiralClass](https://github.com/jaystewartuk/spiralclass)) found four
