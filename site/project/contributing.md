...
- Open an issue before a large change — the project is deliberately
  narrow in scope right now.
- `pnpm typecheck` and `pnpm test` must pass. See
  [Development](/project/development).
- Adding an assertion kind follows a fixed checklist — see
...
Not formally adopted yet — `CONTRIBUTING.md`'s short version ("be direct,
be respectful, assume good faith") is what applies today. This page will
link to a formal one if and when the project adopts it; it isn't invented
here.
